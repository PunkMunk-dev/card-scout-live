          ...
          >
            <div className="mx-auto w-full max-w-[1400px] flex h-14 items-center gap-4 px-4 md:px-6 lg:px-8">
              ...
              <form onSubmit={handleHeaderSearch} className="flex-1 max-w-[480px] ml-auto">
                <div className="relative">
                  <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 pointer-events-none z-10" style={{ color: 'var(--om-text-3)' }} />
                  <input
                    ref={searchInputRef}
                    data-omni-global-search="true"
                    type="text"
                    ...
                    className="flex h-10 w-full rounded-full pl-10 pr-[5.5rem] text-sm om-input"
                  />
                  <button
                    type="submit"
                    className="absolute right-1 top-1/2 -translate-y-1/2 flex items-center gap-1.5 h-8 px-3.5 rounded-full text-[11px] font-semibold tracking-tight shrink-0 transition-all hover:opacity-90 hover:shadow-[0_4px_12px_rgba(0,185,255,0.25)]"
